...
int main(int argc, char** argv) {
    ...
    // FWD/DGRAD: K = lhs inner dim, N = rhs/output outer dim
    // WGRAD: K = OUT_M, N = OUT_N
    Site sites[] = {
    ...
    for (auto& site : sites) {
        ...
        int arg_dim1 = site.is_wgrad ? D1 : D2;  // wgrad: OUT_M, fwd/dgrad: N
        int arg_dim2 = site.is_wgrad ? D2 : D1;  // wgrad: OUT_N, fwd/dgrad: K
        launch_kernel(ref_func, d_a, d_b, d_ref_out, d_a_scale, d_b_scale, d_offs,
                      E, arg_dim1, arg_dim2, stride_a, stride_b, stride_c0, stride_c1, stride_c2, num_sms);
