...
.L8:
	...
	v_add_u32_e32 v16, 0, v214
	v_add_u32_e32 v20, 0, v215
	v_add_u32_e32 v65, 0, v212
	v_add_u32_e32 v67, 0, v213
	...
	s_waitcnt lgkmcnt(0)
	s_barrier
	ds_read_b128 v[0:3], v16 offset:32768
	ds_read_b128 v[4:7], v20 offset:32768
	ds_read_b128 v[226:229], v67
	ds_read_b128 v[222:225], v65
	ds_read_b128 v[8:11], v16 offset:40960
	ds_read_b128 v[12:15], v20 offset:40960
	ds_read_b128 v[230:233], v65 offset:4096
	ds_read_b128 v[234:237], v67 offset:4096
	ds_read_b128 v[28:31], v20 offset:49152
	ds_read_b128 v[24:27], v16 offset:49152
	ds_read_b128 v[16:19], v16 offset:57344
	ds_read_b128 v[20:23], v20 offset:57344
	s_waitcnt lgkmcnt(8)
	...
	ds_read_b128 v[226:229], v67 offset:8192
	ds_read_b128 v[222:225], v65 offset:8192
	ds_read_b128 v[230:233], v65 offset:12288
	ds_read_b128 v[234:237], v67 offset:12288
	s_waitcnt lgkmcnt(2)
	...
	ds_read_b128 v[226:229], v67 offset:16384
	ds_read_b128 v[222:225], v65 offset:16384
	ds_read_b128 v[230:233], v65 offset:20480
	ds_read_b128 v[234:237], v67 offset:20480
	s_waitcnt lgkmcnt(2)
	...
	ds_read_b128 v[226:229], v67 offset:24576
	ds_read_b128 v[222:225], v65 offset:24576
	ds_read_b128 v[230:233], v65 offset:28672
	ds_read_b128 v[234:237], v67 offset:28672
	s_waitcnt lgkmcnt(2)
	...
	v_add_u32_e32 v0, s45, v196
	v_add_u32_e32 v4, s45, v195
	v_mfma_f32_16x16x128_f8f6f4 v[80:83], v[8:15], v[230:237], v[80:83]
	v_add_u32_e32 v8, s45, v194
	...
	s_waitcnt vmcnt(3)
	ds_write_b128 v218, v[0:3] offset:32768
	s_waitcnt vmcnt(2)
	ds_write_b128 v218, v[4:7] offset:40960
	s_waitcnt vmcnt(1)
	ds_write_b128 v218, v[8:11] offset:49152
	s_waitcnt vmcnt(0)
	ds_write_b128 v218, v[12:15] offset:57344
